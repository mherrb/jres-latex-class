...
\documentclass[city=Montpellier,year=2013]{jres}
...
% produit le titre selon les infos ci-desses
\maketitle
...
courantes sont acceptées également. Le texte  normal est en 10 points.
...
Les titres de sont en couleur bleue sombre RGB (0.,0.2,0.375).  
